<%-- 
    Document   : parametrosRelatorioMensal
    Created on : 10/05/2019, 18:55:47
    Author     : Diogo
--%>
...
<html lang="pt-br">
    ...
    <body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div>    
                <div>
                    <h2 class="text-center">Relatório Mensal de Vendas</h2>
                </div>
                <form action="ControleTransacao" method="POST" role="form" data-toggle="validator" class="container">
                    <fieldset>
                        <div class="row">
                            <div class="form-group col-md-2">
                                <label for="txtMes" class="control-label">Mês</label>
                                <select name="txtMes" required="" class="form-control" placeholder="Mes">                                    
                    ...
                    <fieldset>
                        <div>
                            <button type="submit" value="gerarRelatorioMensal" name="acao" class="btn btn-info">Gerar</button> 
