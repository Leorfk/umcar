<%-- 
    Document   : movimentoPanel
    Created on : 01/05/2019, 18:18:26
    Author     : Diogo
--%>
            ...
            <div class="container-fluid">               
                <div class="navbar-header">
                    <form action="ControleTransacao" method="POST" class="navbar-form navbar-left">             
                        <a href="/UMCar_Locacoes_v10/ControleTransacao?acao=interfaceTransacao"><input type="button" value="Inserir nova Transacao" class="btn btn-info"></a>
                        <button type="submit" class="btn btn-info" name="acao" value="Listar">Listagem de Transações</button>                       
                    </form>
                </div>                   
            </div>
            </nav>     
