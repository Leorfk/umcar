<%-- 
    ...
    Created on : 13/05/2019, 16:02:32
    Author     : Diogo
--%>
        ...
        <% List<Cliente> listaCliente = (List<Cliente>) request.getAttribute("listaCliente"); %>
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i>Clientes Cadastrados</h3>
                </div>
                        ...
                        <div class="sui-grid-header">                           
                            <div class="table-responsive container-fluid" style='width: auto'>
                                <table class="table-striped text-center" >
                                    <thead>
                                    <tr>
                                        <th class='col-xs-3'>Id Cliente</th>
                                        <th class='col-xs-3'>Nome</th>
                                        <th class='col-xs-3'>CPF</th>
                                        <th class='col-xs-3'>Telefone Residencial</th>
                                        <th class='col-xs-3'>Telefone Celular</th>
                                    ...
                                    <tr>
                                        ...
                                        <td> <%= cliente.getTelCel()%> </td>
                                        <td> <%= cliente.getEmail()%> </td>  
                                        <td width="auto" class="tCenter"></td>
                                        <td class='col-xs-1'>                                        
                                            <a href="ControleCliente?acao=Consultar&id=<%=cliente.getId()%>"><input type="button" value="Editar" class="btn btn-info"/></a>
                                        </td> 
                                    </tr>                  
                                    <% } %>
                                    </tbody>
                ...
                <div>
                    ...
                    <div class="container-fluid">               
                        <div class="navbar-header">
                            <form action="ControleCliente" method="POST" class="navbar-form navbar-left">           
                                <a href="cadastraCliente.jsp"><input type="button" value="Cadastrar Novo Cliente" name="acao" class="btn btn-info"></a>
                                <button type="submit" class="btn btn-info" name="acao" value="Listar">Listagem de Clientes</button>                       
                            </form>
                        </div>
                    </div>
                    </nav>    
