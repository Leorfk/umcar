<%-- 
    ...
    Created on : 12/05/2019, 18:26:45
    Author     : Kirkh
--%>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">             
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="AutomovelPanel.jsp"><i class="fa fa-car"></i> Cadastro de Imóveis</a></li>
       ...
       <div>
        ...
        <div> 
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" id="firstname" name="txtNomeUsuario" value="<%=usuario.getNomeUsuario() %>">
                <p class="help-block">
        ...
        <div>
            ...
            <div class="col-md-9">
                <input type="email" class="form-control" id="emailaddress" name="txtEmail" value="<%=usuario.getEmail()%>">
                <p class="help-block">
        ...
        <div>
            ...
            <div class="col-md-9">
                <input type="password" class="form-control" id="password" name="txtSenha" value="">
                <p class="help-block">
