<%-- 
    Document   : clientePanel
    Created on : 13/05/2019, 15:37:11
    Author     : Diogo
--%>
...
<html lang="pt-br">
    <head>
        ...
        <title>Manter Cliente - UMCAR</title>
        <meta charset="utf-8">
            ...
            <div class="container-fluid">               
                <div class="navbar-header">
                    <form action="ControleCliente" method="POST" class="navbar-form navbar-left">             
                        <a href="cadastraCliente.jsp"><input type="button" name="acao" value="Cadastrar Novo Cliente" class="btn btn-info"></a>
                        <button type="submit" class="btn btn-info" name="acao" value="Listar">Listagem de Cliente</button>                       
                    </form>
                </div>                   
            </div>
            </nav>     
