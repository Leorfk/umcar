<%-- 
    Document   : relatorioAnual
    Created on : 10/05/2019, 19:30:38
    Author     : Diogo
--%>
                            ...
                            <div class="table-responsive container-fluid" style='width: auto'>
                                <table class="table-striped text-center" >
                                    ...
                                    <tr>
                                        ...
                                        <th class='col-xs-1'>Nome do Cliente</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="t<%= transacao.getCliente().getId() %>"> <%= transacao.getCliente().getCpf() %> </td>
