<%-- 
    Document   : editaCliente
    Created on : 13/05/2019, 18:05:44
    Author     : Diogo
--%>
                ...
                <form action="ControleCliente" method="POST" role="form" data-toggle="validator" class="container">           
                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            ...
                            <input type="text" name="txtNome" required="" class="form-control" placeholder="Nome" value="<%=cliente.getNome() %>">
                        </div>                            
                        <div class="form-group col-md-3">
                            <label for="txtCpf" class="control-label">CPF</label>
                            <input type="text" name="txtCpf" required="" class="form-control" placeholder="Cpf" value="<%=cliente.getCpf() %>">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="txtTelRes" class="control-label">Telefone Residencial</label>
                            <input type="text" name="txtTelRes" required="" class="form-control" placeholder="TelRes" value="<%=cliente.getTelRes() %>">
                        </div>                                                 
                    </div>               
                    <div class="row">    
                        <div class="form-group col-md-2">
                            <label for="txtTelCel" class="control-label">Telefone Celular</label>
                            <input type="text" name="txtTelCel" required="" class="form-control" placeholder="TelCel" value="<%=cliente.getTelCel() %>">
                        </div>                            
                        <div class="form-group col-md-4">
                            <label for="txtEmail" class="control-label">E-mail</label>
                            <input type="text" name="txtEmail" required="" class="form-control" placeholder="Email" value="<%=cliente.getEmail() %>">
                        </div>
                    </div>        
                    <div class="row">
                        <div>
