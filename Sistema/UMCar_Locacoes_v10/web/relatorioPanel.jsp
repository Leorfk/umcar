    ...
    <div id="wrapper">
        ...
        <div>
            ...
            <div class="container-fluid">               
                <div class="navbar-header">           
                        <a href="parametrosRelatorioMensal.jsp"><input type="button" name="acao" value="Relatório Mensal de Vendas" class="btn btn-info"></a>
                        <a href="parametrosRelatorioAnual.jsp"><input type="button" name="acao" value="Relatório Anual de Vendas" class="btn btn-info"></a>
                        <%//<--a href="parametrosRelatorioPeriodo.jsp"><--input type="button" name="acao" value="Relatório de Vendas por Período" class="btn btn-info"><--/a>%>
                </div>                   
            </div>
            </nav>     
        </div>
